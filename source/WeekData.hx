...
class WeekData {
	...
	public static function createTankerKrakenWeekFile():WeekFile {
		var weekFile:WeekFile = {
			songs: !TitleState.tankerKrakenWindowEnabled ? [["Car Tires", "tanker", [0,0,0]],
			["Uncease", "tanker", [0,0,0]],
			["Ceased", "tanker-and-cops", [0,0,0]],
			["Diazepam", "dad", [0,0,0]]] : [["Tanker Kraken", "tanker", [0,0,0]]],
			weekCharacters: ['bf', 'bf', 'bf'],
			weekBackground: 'stage',
			weekBefore: 'tutorial',
			storyName: 'Tanker Kraken',
			weekName: 'Tanker Kraken',
			freeplayColor: [0,0,0],
			startUnlocked: true,
			hiddenUntilUnlocked: false,
			hideStoryMode: false,
