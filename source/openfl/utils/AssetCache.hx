...
class AssetCache implements IAssetCache
{
	...
	**/
	...
	/**
		Internal
	**/
	@:noCompletion @:dox(hide) public static var files:Map<String, String>;
	...
	**/
    ...
    /**
		Adds or replaces a File asset in the cache.

		@param	id	The ID of a File asset
	**/
    public static function set(id:String)
    {
		var file:File = new File(id);
        files.set(id, id);
    }
