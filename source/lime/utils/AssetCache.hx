...
class AssetCache
{
	...
	public function set(id:String, type:AssetType, asset:Dynamic):Void
	{
		...
		{
			case FONT:
                if (!(asset is Dynamic)) throw "Cannot cache non-Font asset: " + asset + " as Font";
				font.set(id, asset);
			case IMAGE:
			...
			case SOUND | MUSIC:
				...
				audio.set(id, asset);
            case TEXT:
                if (!(asset is String)) throw "Cannot cache non-String asset: " + asset + " as String";
				text.set(id, asset);
			default:
