...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		var goption:GameplayOption = new GameplayOption('Scroll Type', 'scrolltype', 'string', 'multiplicative', ["multiplicative", "constant", "fps"]);
		...
		var option:GameplayOption = new GameplayOption('Disable Mechanics', 'mechanics', 'bool', false);
		optionsArray.push(option);
	}
