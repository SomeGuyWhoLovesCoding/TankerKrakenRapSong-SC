...
enum abstract Action(String) to String from String
{
	...
	var NOTE_UP1 = "note_up2";
	var NOTE_LEFT1 = "note_left2";
	var NOTE_RIGHT1 = "note_right2";
	var NOTE_DOWN1 = "note_down2";
	var NOTE_UP_P1 = "note_up-press2";
	var NOTE_LEFT_P1 = "note_left-press2";
	var NOTE_RIGHT_P1 = "note_right-press2";
	var NOTE_DOWN_P1 = "note_down-press2";
	var NOTE_UP_R1 = "note_up-release2";
	var NOTE_LEFT_R1 = "note_left-release2";
	var NOTE_RIGHT_R1 = "note_right-release2";
	var NOTE_DOWN_R1 = "note_down-release2";
	var NOTE_UP2 = "note_up2";
	var NOTE_LEFT2 = "note_left2";
	var NOTE_RIGHT2 = "note_right2";
	var NOTE_DOWN2 = "note_down2";
	var NOTE_UP_P2 = "note_up-press2";
	var NOTE_LEFT_P2 = "note_left-press2";
	var NOTE_RIGHT_P2 = "note_right-press2";
	var NOTE_DOWN_P2 = "note_down-press2";
	var NOTE_UP_R2 = "note_up-release2";
	var NOTE_LEFT_R2 = "note_left-release2";
	var NOTE_RIGHT_R2 = "note_right-release2";
	var NOTE_DOWN_R2 = "note_down-release2";
...
class Controls extends FlxActionSet
{
	...
	// 8K
	var _note_up1 = new FlxActionDigital(Action.NOTE_UP1);
	var _note_left1 = new FlxActionDigital(Action.NOTE_LEFT1);
	var _note_right1 = new FlxActionDigital(Action.NOTE_RIGHT1);
	var _note_down1 = new FlxActionDigital(Action.NOTE_DOWN1);
	var _note_upP1 = new FlxActionDigital(Action.NOTE_UP_P1);
	var _note_leftP1 = new FlxActionDigital(Action.NOTE_LEFT_P1);
	var _note_rightP1 = new FlxActionDigital(Action.NOTE_RIGHT_P1);
	var _note_downP1 = new FlxActionDigital(Action.NOTE_DOWN_P1);
	var _note_upR1 = new FlxActionDigital(Action.NOTE_UP_R1);
	var _note_leftR1 = new FlxActionDigital(Action.NOTE_LEFT_R1);
	var _note_rightR1 = new FlxActionDigital(Action.NOTE_RIGHT_R1);
	var _note_downR1 = new FlxActionDigital(Action.NOTE_DOWN_R1);
	var _note_up2 = new FlxActionDigital(Action.NOTE_UP2);
	var _note_left2 = new FlxActionDigital(Action.NOTE_LEFT2);
	var _note_right2 = new FlxActionDigital(Action.NOTE_RIGHT2);
	var _note_down2 = new FlxActionDigital(Action.NOTE_DOWN2);
	var _note_upP2 = new FlxActionDigital(Action.NOTE_UP_P2);
	var _note_leftP2 = new FlxActionDigital(Action.NOTE_LEFT_P2);
	var _note_rightP2 = new FlxActionDigital(Action.NOTE_RIGHT_P2);
	var _note_downP2 = new FlxActionDigital(Action.NOTE_DOWN_P2);
	var _note_upR2 = new FlxActionDigital(Action.NOTE_UP_R2);
	var _note_leftR2 = new FlxActionDigital(Action.NOTE_LEFT_R2);
	var _note_rightR2 = new FlxActionDigital(Action.NOTE_RIGHT_R2);
	var _note_downR2 = new FlxActionDigital(Action.NOTE_DOWN_R2);
	...
	// 8K CONTROLS
	public var NOTE_UP1(get, never):Bool;

	inline function get_NOTE_UP1()
		return _note_up1.check();

	public var NOTE_LEFT1(get, never):Bool;

	inline function get_NOTE_LEFT1()
		return _note_left1.check();

	public var NOTE_RIGHT1(get, never):Bool;

	inline function get_NOTE_RIGHT1()
		return _note_right1.check();

	public var NOTE_DOWN1(get, never):Bool;

	inline function get_NOTE_DOWN1()
		return _note_down1.check();

	public var NOTE_UP_P1(get, never):Bool;

	inline function get_NOTE_UP_P1()
		return _note_upP1.check();

	public var NOTE_LEFT_P1(get, never):Bool;

	inline function get_NOTE_LEFT_P1()
		return _note_leftP1.check();

	public var NOTE_RIGHT_P1(get, never):Bool;

	inline function get_NOTE_RIGHT_P1()
		return _note_rightP1.check();

	public var NOTE_DOWN_P1(get, never):Bool;

	inline function get_NOTE_DOWN_P1()
		return _note_downP1.check();

	public var NOTE_UP_R1(get, never):Bool;

	inline function get_NOTE_UP_R1()
		return _note_upR1.check();

	public var NOTE_LEFT_R1(get, never):Bool;

	inline function get_NOTE_LEFT_R1()
		return _note_leftR1.check();

	public var NOTE_RIGHT_R1(get, never):Bool;

	inline function get_NOTE_RIGHT_R1()
		return _note_rightR1.check();

	public var NOTE_DOWN_R1(get, never):Bool;

	inline function get_NOTE_DOWN_R1()
		return _note_downR1.check();

	public var NOTE_UP2(get, never):Bool;

	inline function get_NOTE_UP2()
		return _note_up2.check();

	public var NOTE_LEFT2(get, never):Bool;

	inline function get_NOTE_LEFT2()
		return _note_left2.check();

	public var NOTE_RIGHT2(get, never):Bool;

	inline function get_NOTE_RIGHT2()
		return _note_right2.check();

	public var NOTE_DOWN2(get, never):Bool;

	inline function get_NOTE_DOWN2()
		return _note_down2.check();

	public var NOTE_UP_P2(get, never):Bool;

	inline function get_NOTE_UP_P2()
		return _note_upP2.check();

	public var NOTE_LEFT_P2(get, never):Bool;

	inline function get_NOTE_LEFT_P2()
		return _note_leftP2.check();

	public var NOTE_RIGHT_P2(get, never):Bool;

	inline function get_NOTE_RIGHT_P2()
		return _note_rightP2.check();

	public var NOTE_DOWN_P2(get, never):Bool;

	inline function get_NOTE_DOWN_P2()
		return _note_downP2.check();

	public var NOTE_UP_R2(get, never):Bool;

	inline function get_NOTE_UP_R2()
		return _note_upR2.check();

	public var NOTE_LEFT_R2(get, never):Bool;

	inline function get_NOTE_LEFT_R2()
		return _note_leftR2.check();

	public var NOTE_RIGHT_R2(get, never):Bool;

	inline function get_NOTE_RIGHT_R2()
		return _note_rightR2.check();

	public var NOTE_DOWN_R2(get, never):Bool;

	inline function get_NOTE_DOWN_R2()
		return _note_downR2.check();
	...
	function getActionFromControl(control:Control):FlxActionDigital
	{
		return switch (control)
		{
			...
			// 8K
			case NOTE_UP1: _note_up1;
			case NOTE_DOWN1: _note_down1;
			case NOTE_LEFT1: _note_left1;
			case NOTE_RIGHT1: _note_right1;
			case NOTE_UP2: _note_up2;
			case NOTE_DOWN2: _note_down2;
			case NOTE_LEFT2: _note_left2;
			case NOTE_RIGHT2: _note_right2;
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			...
			// 8K
			case NOTE_UP1:
				func(_note_up1, PRESSED);
				func(_note_upP1, JUST_PRESSED);
				func(_note_upR1, JUST_RELEASED);
			case NOTE_LEFT1:
				func(_note_left1, PRESSED);
				func(_note_leftP1, JUST_PRESSED);
				func(_note_leftR1, JUST_RELEASED);
			case NOTE_RIGHT1:
				func(_note_right1, PRESSED);
				func(_note_rightP1, JUST_PRESSED);
				func(_note_rightR1, JUST_RELEASED);
			case NOTE_DOWN1:
				func(_note_down1, PRESSED);
				func(_note_downP1, JUST_PRESSED);
				func(_note_downR1, JUST_RELEASED);
			case NOTE_UP2:
				func(_note_up2, PRESSED);
				func(_note_upP2, JUST_PRESSED);
				func(_note_upR2, JUST_RELEASED);
			case NOTE_LEFT2:
				func(_note_left2, PRESSED);
				func(_note_leftP2, JUST_PRESSED);
				func(_note_leftR2, JUST_RELEASED);
			case NOTE_RIGHT2:
				func(_note_right2, PRESSED);
				func(_note_rightP2, JUST_PRESSED);
				func(_note_rightR2, JUST_RELEASED);
			case NOTE_DOWN2:
				func(_note_down2, PRESSED);
				func(_note_downP2, JUST_PRESSED);
				func(_note_downR2, JUST_RELEASED);
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.NOTE_UP1, keysMap.get('note1_up8k'));
				inline bindKeys(Control.NOTE_DOWN1, keysMap.get('note1_down8k'));
				inline bindKeys(Control.NOTE_LEFT1, keysMap.get('note1_left8k'));
				inline bindKeys(Control.NOTE_RIGHT1, keysMap.get('note1_right8k'));
				inline bindKeys(Control.NOTE_UP2, keysMap.get('note2_up8k'));
				inline bindKeys(Control.NOTE_DOWN2, keysMap.get('note2_down8k'));
				inline bindKeys(Control.NOTE_LEFT2, keysMap.get('note2_left8k'));
				inline bindKeys(Control.NOTE_RIGHT2, keysMap.get('note2_right8k'));
